...
internal fun androidx.fragment.app.FragmentActivity.transact(action: androidx.fragment.app.FragmentTransaction.(Context) -> Unit) =
...
internal fun androidx.fragment.app.Fragment.transact(action: androidx.fragment.app.FragmentTransaction.(Context) -> Unit) {
