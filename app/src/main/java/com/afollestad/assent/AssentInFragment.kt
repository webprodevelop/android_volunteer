 ...
 */
@CheckResult
fun androidx.fragment.app.Fragment.isAllGranted(vararg permissions: Permission) =
 ...
 */
fun androidx.fragment.app.Fragment.askForPermissions(
 ...
 */
fun androidx.fragment.app.Fragment.runWithPermissions(
  vararg permissions: Permission,
  requestCode: Int = 80,
  rationaleHandler: RationaleHandler? = null,
  execute: Callback
