...
public class FragmentRecommended extends FragmentBase {
	...
	static FragmentRecommended fragment = null;
	private String content;

	public static FragmentRecommended getInstance() {
		if (fragment == null) {
			fragment = new FragmentRecommended();
		}
		return fragment;
	}
	...
	protected void initControls(View layout) {
		...
		if (itemNews != null) {
			if (itemNews.title != null) {
				tvTitle.setText(layout.getContext().getResources().getText(R.string.str_recommended_article));
			}
//			if (content != null) {
//				tvContentTitle.setText(itemNews.title);
