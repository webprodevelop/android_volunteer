...
public class FragmentChangeMobile extends FragmentBase implements View.OnClickListener {
	...
	static FragmentChangeMobile fragment = null;

	public static FragmentChangeMobile getInstance() {
		if (fragment == null) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bundle) {
		ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.fragment_change_mobile, container, false);
	...
	protected void initControls(View layout) {
		...
		TextView tvCurAccount = layout.findViewById(R.id.ID_TXTVIEW_CUR_ACCOUNT);
		edtNewAccount = layout.findViewById(R.id.ID_EDTTEXT_NEW_ACCOUNT);
		tvRequiredNewAccount = layout.findViewById(R.id.tvRequiredNewAccount);
		edtVerifyCode = layout.findViewById(R.id.ID_EDTTEXT_VERIFY_CODE);
		tvRequiredAcquireCode = layout.findViewById(R.id.tvRequiredAcquireCode);
		btnAcquire = layout.findViewById(R.id.ID_BUTTON_ACQUIRE);
		tvConfirm = layout.findViewById(R.id.ID_BTN_CONFIRM);
		...
		HttpAPI.updateMobile(Prefs.Instance().getUserToken(), Prefs.Instance().getUserPhone(), strNewMobile, strVerifyCode, new VolleyCallback() {
			...
			public void onSuccess(String response) {
				...
				try {
					...
					Util.showToastMessage(getContext(), R.string.str_change_mobile_success);
